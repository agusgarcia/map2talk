...
public class EasyTween : MonoBehaviour
{
	...
	public void OpenCloseNotHideObjectAnimation()
	{
		rectTransform.gameObject.SetActive(true);

		TriggerOpenCloseNotHide();
	}
	...
	private void TriggerOpenCloseNotHide()
	{
		...
		{			
			currentAnimationGoing.PlayCloseNotHideAnimations();
		}
	}
